    ...
    <div className="w-full">
      ...
      <div className="bg-white rounded-lg border-2 border-gray-200 p-6 mb-6">
        ...
        <div className="space-y-4">
          {/* Option 1 */}
          <label className="flex items-start p-4 rounded-lg border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50/30 cursor-pointer transition-all">
            <input
              type="radio"
              name="ordonnance"
              value="oui-domicile"
              ...
              className="w-5 h-5 mt-0.5 border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 cursor-pointer"
            />
      ...
      {(aOrdonnance === "oui-domicile" || aOrdonnance === "oui-sans") && (
        <div className="bg-white rounded-lg border-2 border-gray-200 p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              className="w-full px-4 py-3 border-2 border-dashed border-blue-400 rounded-lg text-blue-600 hover:bg-blue-50 transition-all font-medium"
            >
              + Ajouter un document
            </button>
      ...
      <div className="flex justify-between pt-6 border-t border-gray-200">
        ...
        <Button onClick={handleContinue} disabled={!aOrdonnance} size="lg">
          Continuer
        </Button>
      </div>
    </div>
